...
class FieldPresence
{
    ...
    private static $valueToName = [self::FIELD_PRESENCE_UNKNOWN => 'FIELD_PRESENCE_UNKNOWN', self::EXPLICIT => 'EXPLICIT', self::IMPLICIT => 'IMPLICIT', self::LEGACY_REQUIRED => 'LEGACY_REQUIRED'];
