...
namespace Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\FileOptions;
...
class OptimizeMode
{
    ...
    private static $valueToName = [self::SPEED => 'SPEED', self::CODE_SIZE => 'CODE_SIZE', self::LITE_RUNTIME => 'LITE_RUNTIME'];
