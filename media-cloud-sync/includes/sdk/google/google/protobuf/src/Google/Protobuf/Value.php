 ...
 */
class Value extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    protected $kind;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\NullValue::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\ListValue::class);
