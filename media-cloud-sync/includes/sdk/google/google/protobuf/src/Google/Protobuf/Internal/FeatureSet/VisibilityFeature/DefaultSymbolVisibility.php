...
namespace Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\FeatureSet\VisibilityFeature;
...
class DefaultSymbolVisibility
{
     ...
     */
    const STRICT = 4;
    private static $valueToName = [self::DEFAULT_SYMBOL_VISIBILITY_UNKNOWN => 'DEFAULT_SYMBOL_VISIBILITY_UNKNOWN', self::EXPORT_ALL => 'EXPORT_ALL', self::EXPORT_TOP_LEVEL => 'EXPORT_TOP_LEVEL', self::LOCAL_ALL => 'LOCAL_ALL', self::STRICT => 'STRICT'];
