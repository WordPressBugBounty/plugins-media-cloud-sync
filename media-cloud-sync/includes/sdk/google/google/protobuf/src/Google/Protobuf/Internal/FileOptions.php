 ...
 */
class FileOptions extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Google\Protobuf\Internal\FileOptions\OptimizeMode::class);
