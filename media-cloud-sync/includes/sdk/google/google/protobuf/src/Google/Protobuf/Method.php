 ...
 */
class Method extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        if ($this->syntax !== 0) {
            @\trigger_error('syntax is deprecated.', \E_USER_DEPRECATED);
        }
        return $this->syntax;
    }
    /**
    ...
    {
        if ($this->edition !== '') {
            @\trigger_error('edition is deprecated.', \E_USER_DEPRECATED);
        }
        return $this->edition;
    }
    /**
