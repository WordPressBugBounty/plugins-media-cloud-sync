...
namespace Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\MethodOptions;
...
class IdempotencyLevel
{
     ...
     */
    const IDEMPOTENT = 2;
    private static $valueToName = [self::IDEMPOTENCY_UNKNOWN => 'IDEMPOTENCY_UNKNOWN', self::NO_SIDE_EFFECTS => 'NO_SIDE_EFFECTS', self::IDEMPOTENT => 'IDEMPOTENT'];
