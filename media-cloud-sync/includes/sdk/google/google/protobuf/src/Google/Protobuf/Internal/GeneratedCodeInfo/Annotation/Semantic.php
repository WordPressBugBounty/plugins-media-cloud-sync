...
namespace Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GeneratedCodeInfo\Annotation;
...
class Semantic
{
     ...
     */
    const ALIAS = 2;
    private static $valueToName = [self::NONE => 'NONE', self::SET => 'SET', self::ALIAS => 'ALIAS'];
