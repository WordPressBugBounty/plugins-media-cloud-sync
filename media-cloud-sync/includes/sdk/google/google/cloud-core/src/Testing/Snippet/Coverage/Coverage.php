 ...
 */
namespace Dudlewebs\WPMCS\Google\Cloud\Core\Testing\Snippet\Coverage;

use Dudlewebs\WPMCS\Google\Cloud\Core\Testing\Snippet\Parser\Snippet;
/**
 * Class Coverage
 *
 * @experimental
...
class Coverage
{
    private static $snippetExcludeList = ['/\\\\GcTestListener/', '/\\\\Google\\\\Cloud\\\\Core\\\\Logger/', '/\\\\Google\\\\Cloud\\\\Core\\\\PhpArray/', '/\\\\Google\\\\Cloud\\\\Translate\\\\TranslateClient/', '/\\\\Google\\\\Cloud\\\\Translate\\\\Connection\\\\Rest/', '/\\\\Google\\\\Cloud\\\\Translate\\\\Connection\\\\ConnectionInterface/'];
    /**
