...
class CloudRunServiceMetadataProvider implements MetadataProviderInterface
{
    ...
    {
        return ['type' => 'cloud_run_revision', 'labels' => ['configuration_name' => $this->configurationId, 'location' => $this->region, 'project_id' => $this->projectId(), 'revision_name' => $this->revisionId, 'service_name' => $this->serviceId]];
    }
    /**
    ...
    {
        $labels = ['instanceId' => $this->instanceId, 'run.googleapis.com/trace_id' => $this->traceId];
