 ...
 */
class ApiConfig extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GCP\GPBMetadata\GrpcGcp::initOnce();
        parent::__construct();
    }
    /**
     * The channel pool configurations.
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Grpc\Gcp\ChannelPoolConfig::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Grpc\Gcp\MethodConfig::class);
        $this->method = $arr;
        return $this;
    }
}
