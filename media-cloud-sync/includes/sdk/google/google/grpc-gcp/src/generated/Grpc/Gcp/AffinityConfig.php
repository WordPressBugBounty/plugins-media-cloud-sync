 ...
 */
class AffinityConfig extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Grpc\Gcp\AffinityConfig_Command::class);
        $this->command = $var;
        return $this;
    }
    /**
