 ...
 */
class AuditData extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GPBMetadata\Google\Iam\V1\Logging\AuditData::initOnce();
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Cloud\Iam\V1\PolicyDelta::class);
