 ...
 */
class AuditLogConfig extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Cloud\Iam\V1\AuditLogConfig\LogType::class);
        $this->log_type = $var;
        return $this;
    }
    /**
