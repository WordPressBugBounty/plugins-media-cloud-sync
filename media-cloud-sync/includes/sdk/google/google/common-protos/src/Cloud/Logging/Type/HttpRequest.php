...
namespace Dudlewebs\WPMCS\Google\Cloud\Logging\Type;
 ...
 */
class HttpRequest extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GPBMetadata\Google\Logging\Type\HttpRequest::initOnce();
