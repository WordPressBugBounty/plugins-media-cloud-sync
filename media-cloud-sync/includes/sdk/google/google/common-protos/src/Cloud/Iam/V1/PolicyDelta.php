 ...
 */
class PolicyDelta extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GCP\GPBMetadata\Google\Iam\V1\Policy::initOnce();
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Google\Cloud\Iam\V1\BindingDelta::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Google\Cloud\Iam\V1\AuditConfigDelta::class);
