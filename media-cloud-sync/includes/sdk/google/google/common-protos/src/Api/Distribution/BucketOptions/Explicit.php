...
namespace Dudlewebs\WPMCS\GCP\Google\Api\Distribution\BucketOptions;
 ...
 */
class Explicit extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::DOUBLE);
        $this->bounds = $arr;
        return $this;
    }
}
