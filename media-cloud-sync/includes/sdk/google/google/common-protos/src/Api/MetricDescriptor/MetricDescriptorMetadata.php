...
namespace Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor;
 ...
 */
class MetricDescriptorMetadata extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Duration::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::ENUM, \Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor\MetricDescriptorMetadata\TimeSeriesResourceHierarchyLevel::class);
