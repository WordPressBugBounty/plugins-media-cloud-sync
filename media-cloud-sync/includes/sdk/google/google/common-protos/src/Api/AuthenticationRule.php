 ...
 */
class AuthenticationRule extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\OAuthRequirements::class);
        $this->oauth = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\Google\Api\AuthRequirement::class);
