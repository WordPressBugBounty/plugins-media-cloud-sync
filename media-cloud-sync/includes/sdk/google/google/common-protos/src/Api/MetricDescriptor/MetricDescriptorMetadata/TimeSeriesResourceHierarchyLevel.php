...
namespace Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor\MetricDescriptorMetadata;
...
class TimeSeriesResourceHierarchyLevel
{
     ...
     */
    const FOLDER = 3;
    private static $valueToName = [self::TIME_SERIES_RESOURCE_HIERARCHY_LEVEL_UNSPECIFIED => 'TIME_SERIES_RESOURCE_HIERARCHY_LEVEL_UNSPECIFIED', self::PROJECT => 'PROJECT', self::ORGANIZATION => 'ORGANIZATION', self::FOLDER => 'FOLDER'];
