 ...
 */
class MonitoredResourceMetadata extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Struct::class);
