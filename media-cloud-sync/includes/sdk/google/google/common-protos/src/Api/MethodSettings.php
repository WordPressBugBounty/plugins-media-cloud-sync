 ...
 */
class MethodSettings extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\MethodSettings\LongRunning::class);
