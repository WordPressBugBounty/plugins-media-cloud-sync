 ...
 */
class FieldInfo extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GCP\GPBMetadata\Google\Api\FieldInfo::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Api\FieldInfo\Format::class);
        $this->format = $var;
        return $this;
    }
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Google\Api\TypeReference::class);
