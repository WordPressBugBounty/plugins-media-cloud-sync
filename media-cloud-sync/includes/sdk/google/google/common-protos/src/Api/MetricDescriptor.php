 ...
 */
class MetricDescriptor extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\Google\Api\LabelDescriptor::class);
        $this->labels = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Google\Api\MetricDescriptor\MetricKind::class);
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Google\Api\MetricDescriptor\ValueType::class);
        $this->value_type = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\MetricDescriptor\MetricDescriptorMetadata::class);
        $this->metadata = $var;
        return $this;
    }
    /**
