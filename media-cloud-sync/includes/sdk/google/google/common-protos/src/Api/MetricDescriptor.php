 ...
 */
class MetricDescriptor extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Google\Api\LabelDescriptor::class);
        $this->labels = $arr;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor\MetricKind::class);
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor\ValueType::class);
        $this->value_type = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\MetricDescriptor\MetricDescriptorMetadata::class);
        $this->metadata = $var;
        return $this;
    }
    /**
