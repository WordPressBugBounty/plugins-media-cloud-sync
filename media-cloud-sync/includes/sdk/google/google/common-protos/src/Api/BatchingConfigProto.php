 ...
 */
class BatchingConfigProto extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\BatchingSettingsProto::class);
        $this->thresholds = $var;
        return $this;
    }
    /**
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\BatchingDescriptorProto::class);
