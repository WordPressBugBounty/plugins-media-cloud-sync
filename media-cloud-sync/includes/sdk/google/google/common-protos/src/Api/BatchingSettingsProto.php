 ...
 */
class BatchingSettingsProto extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Google\Api\FlowControlLimitExceededBehaviorProto::class);
