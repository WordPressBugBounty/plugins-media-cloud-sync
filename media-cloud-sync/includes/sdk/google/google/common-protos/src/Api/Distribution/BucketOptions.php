...
namespace Dudlewebs\WPMCS\GCP\Google\Api\Distribution;
 ...
 */
class BucketOptions extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    protected $options;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\Distribution\BucketOptions\Linear::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\Distribution\BucketOptions\Exponential::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\Distribution\BucketOptions\Explicit::class);
