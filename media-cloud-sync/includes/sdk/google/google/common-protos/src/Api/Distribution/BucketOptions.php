 ...
 */
class BucketOptions extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    protected $options;
    /**
     * Constructor.
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\Distribution\BucketOptions\Linear::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\Distribution\BucketOptions\Exponential::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\Distribution\BucketOptions\Explicit::class);
