 ...
 */
class CommonLanguageSettings extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::ENUM, \Dudlewebs\WPMCS\GCP\Google\Api\ClientLibraryDestination::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\GCP\Google\Api\SelectiveGapicGeneration::class);
