 ...
 */
class CommonLanguageSettings extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\Google\Protobuf\Internal\GPBType::ENUM, \Dudlewebs\WPMCS\Google\Api\ClientLibraryDestination::class);
    ...
    {
        GPBUtil::checkMessage($var, \Dudlewebs\WPMCS\Google\Api\SelectiveGapicGeneration::class);
