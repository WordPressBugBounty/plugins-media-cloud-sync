 ...
 */
class ConfigChange extends \Dudlewebs\WPMCS\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GPBMetadata\Google\Api\ConfigChange::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\Google\Api\ChangeType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\Google\Api\Advice::class);
        $this->advices = $arr;
        return $this;
    }
}
