 ...
 */
class ConfigChange extends \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        \Dudlewebs\WPMCS\GCP\GPBMetadata\Google\Api\ConfigChange::initOnce();
    ...
    {
        GPBUtil::checkEnum($var, \Dudlewebs\WPMCS\GCP\Google\Api\ChangeType::class);
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Dudlewebs\WPMCS\GCP\Google\Protobuf\Internal\GPBType::MESSAGE, \Dudlewebs\WPMCS\GCP\Google\Api\Advice::class);
        $this->advices = $arr;
        return $this;
    }
}
