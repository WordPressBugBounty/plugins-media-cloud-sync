...
use Dudlewebs\WPMCS\s3\Aws\Auth\AuthResolver;
use Dudlewebs\WPMCS\s3\Aws\Auth\AuthSchemeResolver;
...
use Dudlewebs\WPMCS\s3\Aws\Token\Token;
use Dudlewebs\WPMCS\s3\Aws\Token\TokenInterface;
use Dudlewebs\WPMCS\s3\Aws\Token\BedrockTokenProvider;
use Dudlewebs\WPMCS\s3\Aws\Token\TokenProvider;
...
class ClientResolver
{
    ...
    public static function _apply_endpoint_provider($value, array &$args)
    {
        if (!isset($args['endpoint'])) {
            if ($value instanceof \Dudlewebs\WPMCS\s3\Aws\EndpointV2\EndpointProviderV2) {
    ...
    public static function _default_endpoint_provider(array $args)
    {
        ...
        if (self::isValidService($serviceName) && self::isValidApiVersion($serviceName, $apiVersion)) {
            ...
            return new \Dudlewebs\WPMCS\s3\Aws\EndpointV2\EndpointProviderV2($ruleset, EndpointDefinitionProvider::getPartitions());
        }
        $options = self::getEndpointProviderOptions($args);
    ...
    public static function _apply_suppress_php_deprecation_warning($value, &$args)
    {
        if ($value) {
            ...
            $args['suppress_php_deprecation_warning'] = \Dudlewebs\WPMCS\s3\Aws\boolean_value(\getenv("AWS_SUPPRESS_PHP_DEPRECATION_WARNING"));
        } elseif (!empty($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \Dudlewebs\WPMCS\s3\Aws\boolean_value($_SERVER["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        } elseif (!empty($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"])) {
            $args['suppress_php_deprecation_warning'] = \Dudlewebs\WPMCS\s3\Aws\boolean_value($_ENV["AWS_SUPPRESS_PHP_DEPRECATION_WARNING"]);
        }
    ...
    public static function _default_endpoint(array &$args)
    {
        ...
        $serviceIdentifier = \Dudlewebs\WPMCS\s3\Aws\manifest($args['service'])['serviceIdentifier'];
...
EOT;
    ...
    private static function isValidService($service)
    {
        ...
        $services = \Dudlewebs\WPMCS\s3\Aws\manifest();
