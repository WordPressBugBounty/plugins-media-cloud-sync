...
use Dudlewebs\WPMCS\s3\Aws\Credentials\CredentialSources;
use Dudlewebs\WPMCS\s3\Aws\Token;
...
final class MetricsBuilder
{
    ...
    private function appendRetryConfigMetric(array $args) : void
    {
        ...
        $retryMode = '';
        if ($retries instanceof \Dudlewebs\WPMCS\s3\Aws\Retry\Configuration) {
