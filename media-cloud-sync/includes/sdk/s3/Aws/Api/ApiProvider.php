...
use Dudlewebs\WPMCS\s3\Aws\Exception\UnresolvedApiException;
/**
 * API providers.
 *
...
class ApiProvider
{
    ...
    {
        return new self(__DIR__ . '/../data', \Dudlewebs\WPMCS\s3\Aws\manifest());
    }
    /**
    ...
    public function __invoke($type, $service, $version)
    {
        ...
        try {
            return \Dudlewebs\WPMCS\s3\Aws\load_compiled_json($path);
